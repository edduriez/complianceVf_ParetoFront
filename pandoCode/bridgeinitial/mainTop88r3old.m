function [initVf,mincP1,VfmincP1,mincP1vfOK,VfmincP1vfOK]=mainTop88r3old(nelx,nely,volfrac)
...
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'volfrac'); %get top88 design
compliance1=evaluateTotalDesign(xPhys,1,'MBB');
vf1=mean(mean(xPhys));
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'box0'); %get top88 design
compliance2=evaluateTotalDesign(xPhys,1,'MBB');
vf2=mean(mean(xPhys));
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'boxgrey'); %get top88 design
compliance3=evaluateTotalDesign(xPhys,1,'MBB');
vf3=mean(mean(xPhys));
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'1'); %get top88 design
compliance4=evaluateTotalDesign(xPhys,1,'MBB');
vf4=mean(mean(xPhys));
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'box05'); %get top88 design
compliance5=evaluateTotalDesign(xPhys,1,'MBB');
vf5=mean(mean(xPhys));
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'x05'); %get top88 design
compliance6=evaluateTotalDesign(xPhys,1,'MBB');
vf6=mean(mean(xPhys));
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'x0'); %get top88 design
compliance7=evaluateTotalDesign(xPhys,1,'MBB');
vf7=mean(mean(xPhys));
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'xgrey'); %get top88 design
compliance8=evaluateTotalDesign(xPhys,1,'MBB');
vf8=mean(mean(xPhys));
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'xbox05'); %get top88 design
compliance9=evaluateTotalDesign(xPhys,1,'MBB');
vf9=mean(mean(xPhys));
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'xbox0'); %get top88 design
compliance10=evaluateTotalDesign(xPhys,1,'MBB');
vf10=mean(mean(xPhys));
[xPhys]=top88DesignMBBold(nelx,nely,volfrac,3,3,1,'xboxgrey'); %get top88 design
