...
[xPhys]=top88DesignMBB(nelx,nely,volfrac,3,3,1,'manyxboxgrey'); %get top88 design
compliance12=evaluateTotalDesign(xPhys,1,'MBB');
vf12=mean(mean(xPhys));
[xPhys]=top88DesignMBB(nelx,nely,volfrac,3,3,1,'manyxbox0'); %get top88 design
compliance13=evaluateTotalDesign(xPhys,1,'MBB');
vf13=mean(mean(xPhys));
[xPhys]=top88DesignMBB(nelx,nely,volfrac,3,3,1,'manyxbox05'); %get top88 design
compliance14=evaluateTotalDesign(xPhys,1,'MBB');
vf14=mean(mean(xPhys));
[xPhys]=top88DesignMBB(nelx,nely,volfrac,3,3,1,'manyxboxgrey1'); %get top88 design
compliance15=evaluateTotalDesign(xPhys,1,'MBB');
vf15=mean(mean(xPhys));
[xPhys]=top88DesignMBB(nelx,nely,volfrac,3,3,1,'manyxbox01'); %get top88 design
compliance16=evaluateTotalDesign(xPhys,1,'MBB');
vf16=mean(mean(xPhys));
[xPhys]=top88DesignMBB(nelx,nely,volfrac,3,3,1,'manyxbox051'); %get top88 design
compliance17=evaluateTotalDesign(xPhys,1,'MBB');
vf17=mean(mean(xPhys));

%comp=[compliance1,compliance2,compliance3,compliance4,compliance5,compliance6,compliance7,compliance8,compliance9,compliance10,compliance11,compliance12,compliance13,compliance14,compliance15,compliance16,compliance17];
%vf=[vf1,vf2,vf3,vf4,vf5,vf6,vf7,vf8,vf9,vf10,vf11,vf12,vf13,vf14,vf15,vf16,vf17];
comp=[compliance2,compliance3,compliance5,compliance6,compliance7,compliance8,compliance9,compliance10,compliance11,compliance12,compliance13,compliance14,compliance15,compliance16,compliance17];
vf=[vf2,vf3,vf5,vf6,vf7,vf8,vf9,vf10,vf11,vf12,vf13,vf14,vf15,vf16,vf17];
